...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    OrdersByStatus: typeof import('./src/components/dashboard/OrdersByStatus.vue')['default']
    RecentOrders: typeof import('./src/components/dashboard/RecentOrders.vue')['default']
    RevenueChart: typeof import('./src/components/dashboard/RevenueChart.vue')['default']
    RouterLink: typeof import('vue-router')['RouterLink']
    RouterView: typeof import('vue-router')['RouterView']
    ThemeSwitcher: typeof import('./src/@core/components/ThemeSwitcher.vue')['default']
    TopServices: typeof import('./src/components/dashboard/TopServices.vue')['default']
